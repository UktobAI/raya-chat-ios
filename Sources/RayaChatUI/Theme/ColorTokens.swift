...
public enum LightColors {
    ...
    public static let onlineBadgeBg = Color(hex: 0xFFFFFF)
    public static let onlineBadgeBorder = Color(hex: 0xE4E4E7)
    public static let onlineDot = Color(hex: 0x22C55E)
    public static let onlineText = Color(hex: 0x14161A)
...
public enum DarkColors {
    ...
    public static let onlineBadgeBg = Color(hex: 0x27272A)
    public static let onlineBadgeBorder = Color(hex: 0x3F3F46)
    public static let onlineDot = Color(hex: 0x22C55E)
    public static let onlineText = Color(hex: 0xF1F1F0)
    public static let errorRed = Color(hex: 0xEF4444)
    public static let destructive = Color(hex: 0xEF4444)
}
